...
<body>
    ...
    <section id="formIns">
        <div class="container">
            ...
            <!-- Formulaire pour se connecter, on redirigie l'utilisateur vers la servlet Login pour que celui s'assure de l'existence de l'utilisateur et le connecte ou bien le redirige vers la page d'inscription si ce dernier n'existe pas  -->
            ...
            <a href="/servlet_jsp/inscription.jsp">Inscription</a>
        </div>
    </section>
