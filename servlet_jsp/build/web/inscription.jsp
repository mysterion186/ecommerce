    ...
    <section id="formIns">
        <div class="container">
            <div class="titre">Inscription</div>
             <!-- Formulaire pour s'inscrire, on redirige l'utilisateur vers la servlet Login pour qu'il s'assure de l'enregistrement de l'utilisateur dans la base de données-->
