...
<body>
   ...
   <!-- La servlet ArticleServlet sait sur quel produit l'utilisateut àa cliqué, et il a mis les informations sur ce produit dans la session, on y accède donc avec la ligne suivante-->
    <% 
    ...
    <section id="prodetails" class="section-p1">
        ...
        <div class="single-pro-details">
            ...
            <!-- Formulaire pour ajouter des articles aux panier, la servlet PanierServlet va vérifier si l'utilisateur est connecté et si oui on ajoute l'article dans le panier sinon on le redirige vers la page connexion -->
